...
export default function WhatsAppButton() {
  ...
  const openWhatsApp = () => {
    window.open(
      'https://wa.me/51123456789?text=Hola%2C%20me%20interesa%20cotizar%20un%20proyecto%20residencial',
      '_blank'
    )
  }
  ...
  return (
    <button
      ...
      className={`fixed bottom-8 right-8 w-14 h-14 rounded-full bg-green-500 hover:bg-green-600 text-white shadow-lg flex items-center justify-center transition-all duration-300 z-40 ${
